...
export class IERC20Minimal extends ethereum.SmartContract {
  static bind(address: Address): IERC20Minimal {
    return new IERC20Minimal("IERC20Minimal", address);
  }
  ...
  burnFrom(account: Address, amount: BigInt): boolean {
  ...
  try_burnFrom(account: Address, amount: BigInt): ethereum.CallResult<boolean> {
  ...
  mintTo(account: Address, amount: BigInt): boolean {
  ...
  try_mintTo(account: Address, amount: BigInt): ethereum.CallResult<boolean> {
